...
// var serviceAccount = JSON.parse(process.env.SERVICE_ACCOUNT); upload-p
// var serviceAccount = JSON.parse() //yaha pe firebase wala code lagyga 
var serviceAccount = require("./firebase.json");
admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: "https://upload-p.firebaseio.com" //firebase url lagyga 
});
const bucket = admin.storage().bucket("gs://upload-p~.appspot.com"); //yaha pe firebase wala bucket ka code lagyga
